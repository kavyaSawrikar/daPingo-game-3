...
function preload() {
  backgroundImg = loadImage("nightSky.jpeg")
...
if(gameState === "end"){
  ...
  fill(rgb(255,217,255))
  textSize(100)
  text("Game Over", 145,600);

  textSize(50);
  text("Your Score Was "+ score,175,700)

  if(score === 2500){

    textSize(50)
    text("thats the best you can do good job!", 15,800) 
  }
}
}
